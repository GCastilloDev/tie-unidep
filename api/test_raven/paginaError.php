...
<div class='parallax-container'>
    ...
    <ul class='collapsible'>
        ...
        <div class='col s9'>
            <div class='container'>
                <h4 class='center'>Test de Raven - Resultado</h4>
                ...
                <p class='right'>
                <a href='test-de-raven.php' class='waves-effect waves-light btn-small brown darken-3 pulse'><i class='material-icons right'>reply</i>REGRESAR</a>
                </p>

<div style="margin-top:30px">
    <ul class="collapsible">
        ...
        <li>
            ...
            <div class="collapsible-body">
                <p><a href="test/test-domino.php" class="teal-text text-darken-4">Test Domino</a></p>
            </div>
            <div class="collapsible-body">
                <p><a href="test/test-de-raven.php" class="teal-text text-darken-4">Test de Raven</a></p>
            </div>
            <div class="collapsible-body">
                <p><a href="test/test-de-terman-merril.php" class="teal-text text-darken-4">Test de Terman Merril</a></p>
            </div>
            <div class="collapsible-body">
                <p><a href="test/test-de-colores.php" class="teal-text text-darken-4">Test de Colores</a></p>
            </div>
            <div class="collapsible-body">
                <p><a href="test/test-de-moss.php" class="teal-text text-darken-4">Test de Moss</a></p>
            </div>
            <div class="collapsible-body">
                <p><a href="test/test-de-cleaver.php" class="teal-text text-darken-4">Test de Cleaver</a></p>
            </div>
        </li>
    </ul>
</div>